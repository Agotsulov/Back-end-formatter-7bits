...
public interface Container {
    ...
    Но я не знаю как тогда загружать это из json.
    TODO: Разделить load и file методы на разные интерфейсы. И вообще полностью предлелать загрузку через json чтобы там все переменный были
     */
